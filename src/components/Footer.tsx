        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-semibold">MediScribe</span>
            </div>
            <p className="text-gray-300 mb-4">
              Converting medical audio to text with precision and security.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-medical-teal transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-medical-teal mt-0.5" />
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">contact@mediscribe.com</span>
              </div>
            </div>
          </div>
        </div>
